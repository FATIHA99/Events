    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-6">
                <h1 class="text-3xl font-extrabold big-title">Edit Event</h1>
            </div>
            ...
            <form action="{{ route('admin.update', $event->id) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input name="date" type="date" value="{{ old('date', \Carbon\Carbon::parse($event->date)->format('Y-m-d')) }}" 
                ...
                <div class="mb-6">
                    ...
                    <input name="rsvp_limit" type="number" value="{{ old('rsvp_limit', $event->rsvp_limit) }}" min="3" 
